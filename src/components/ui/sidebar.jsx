...
function SidebarHeader({
  ...
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(`flex flex-col gap-2 p-2 ${state === 'collapsed' ? 'text-l' : 'text-2xl'}`, className)}
      {...props} />
  );
}
...
function SidebarGroup({
  ...
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(`relative flex w-full min-w-0 flex-col p-2 ${state != 'collapsed' && 'px-6'}`, className)}
      {...props} />
  );
}
